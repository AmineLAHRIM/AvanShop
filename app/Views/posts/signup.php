    ...
    <div class="main main2">
        ...
        <form class="newform" action="" method="post">
            ...
            <div class="inputGroup inputGroup1">
                ...
                <input type="text" name="Email" pattern=".+@.+.com" id="email" class="email" required maxlength="256"/>
            ...
            <div class="inputGroup inputGroup1">
                ...
                <input type="text" name="Nom"   title="email@domaine.com" id="nom" class="email" required maxlength="256"/>
            ...
            <div class="inputGroup inputGroup1">
                ...
                <input type="text" name="Prenom" id="prenom"  class="email"required maxlength="256"/>
                <p class="helper helper1"></p>
                <span class="indicator"></span>
            </div>
            <div class="inputGroup inputGroup1">
                ...
                <input type="text" name="Tele" id="tele"  pattern="[0-9]{10}" title="10 Numeros"  class="email" required maxlength="20"/>
                <p class="helper helper1"></p>
                <span class="indicator"></span>
            </div>
            <div class="inputGroup inputGroup1">
                <!--Adresse-->
                <label for="tele">Adresse</label>
                <input type="text" name="Adresse" id="adresse" class="email" required maxlength="200"/>
                <p class="helper helper1"></p>
                <span class="indicator"></span>
            </div>
            <div class="inputGroup inputGroup2">
                ...
                <input type="password" name="Pass" id="pass" required class="password"/>
                <!--confirm password-->
                <label for="confirmpass">Confirm Password</label>
                <input type="password" id="confirmpass" title="Mot de passe ne Correspont pas au dernier" required class="password"/>
            </div>
            <div class="inputGroup inputGroup3">
                <button id="register" type="submit">Join Free</button>
            </div>
        </form>
