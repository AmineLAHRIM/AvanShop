<div class="content">
    <div class="main main2">
        <form class="formboutique newform" method="post" action="">
            <div class="Title3">
            ...
            <div class="inputGroup inputGroup1">
                ...
                <input type="text" required id="email" name="Nom_boutique" class="email" maxlength="256"/>
                <p class="helper helper1 boutique">Store Name</p>
                <span class="indicator"></span>
            </div>
            <div class="inputGroup inputGroup1">
                <!--First Name-->

                <textarea type="text" id="shortdes" required name="Short_descriptionB" class="email" maxlength="256"></textarea>
                <p class="helper helper1 boutique">Short Description</p>
                <span class="indicator"></span>
            </div>
            <div class="inputGroup inputGroup1">
                <!--Last Name-->

                <textarea type="text" id="longdes" required name="Long_DescriptionB" class="email" maxlength="256"></textarea>
                <p class="helper helper1 boutique">Long Description</p>
                <span class="indicator"></span>
            </div>
            <div class="inputGroup inputGroup2" style="display: none">
                <!--password-->
                <label for="pass">Password</label>
                <input type="password"  id="pass" class="password"/>
                <!--confirm password-->
                <label for="confirmpass">Confirm Password</label>
                <input type="password" id="confirmpass" class="password"/>
            </div>
            <div class="inputGroup inputGroup3">
                <button id="register" type="submit">Create Store</button>
            </div>
        </form>
