    ...
    <div class="main main2">
        <form class="newform" action="" method="post">
            ...
            <div class="inputGroup inputGroup1">
                ...
                <input type="text" name="Email" id="email" class="email" required maxlength="256"/>
                <p class="helper helper1">email@domain.com</p>
                <span class="indicator"></span>
            </div>
            <div class="inputGroup inputGroup2">
                <label for="password">Password</label>
                <input type="password" name="Pass" id="password" required class="password"/>
            </div>
...
<!--<div class="sidebar">
    <div class="sidebar-container">
        <div class="bloc" data-sticky data-offset="70" data-constraint=".sidebar-container">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus atque dolor doloremque, doloribus
            hic illum impedit inventore ipsam laudantium minima, nam nemo officiis quo rem repellat sapiente ullam
            unde vel.
        </div>
    </div>
</div>-->
